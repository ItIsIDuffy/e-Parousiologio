...
public class NewAttendanceEntry {
    ...
    public NewAttendanceEntry() {}

    public NewAttendanceEntry(String studentAEM, String fullName, String courseId, String courseTitle, String labId, String labName, boolean wasPresent) {
